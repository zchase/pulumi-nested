...
namespace Pulumi.Nested
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Nested.version.txt");
    ...
    internal sealed class NestedResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NestedResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
